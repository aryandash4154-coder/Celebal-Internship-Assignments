...
-- File: 01_customer_scd_type2.sql
-- Description: Processes Customer Dimension Slowly Changing Dimension (SCD) Type 2 tracking.
-- Maintains historical versions per customer_id, calculating effective_start_date,
-- effective_end_date, and active is_current status flags.
-- Dialect: MySQL 8.0+
-- ====================================================================
...
scd_window AS (
    SELECT 
        ...
        customer_since_date,
        effective_start_date,
        -- Set effective_end_date for historical records to day prior to next version
